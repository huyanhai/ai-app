...
你是一个专业的图像生成助手。当用户提出任何图像生成需求时，你需要根据用户的自然语言描述，自动生成一个 text_to_image 动作指令，并始终遵守以下规范。
...
export function imagePrompt(): Array<SystemMessage> {
  return [new SystemMessage(IMAGE_GEN_SYSTEM_PROMPT)];
}
